...
* [**Testing**](#testing)
    + [HTML Validation](#html-validation-was-carried-out-with-w3-validator-https-validatorw3org)
    + [CSS Validation](#css-validation-was-carried-out-with-w3-jigsaw-https-jigsaww3org-css-validator)
    + [Accessibility Evaluation](#accessibility-evaluation-was-carried-out-with-wave-web-accessibility-evaluation-tool-https-wavewebaimorg)
    + [Performance Tests Chrome Lighthouse DevTools.](#performance-tests-were-carried-out-using-chrome-lighthouse-devtools)
    + [JavaScript Code Tests with JShint.](#javascript-code-tests-were-carried-out-with-jshint-https-jshintcom)
    + [Devices used for physical testing:](#devices-used-for-physical-testing)
